  ...
  <?php include("preloader.php")?>
    ...
    <?php include("header.php")?>
      ...
      <section class="section section-lg bg-default">
        ...
        <div class="container">
            <div class="wow fadeInRight" data-wow-delay=".2s">
              <h3>GPS vehicular y personal</h3>
              <div class="row row-30">
      ...
      <section class="section section-md bg-gray-lighten">
        <div class="container">
          <div class="col-md col-12 text-center">
            <h3 class="wow fadeInLeft text-capitalize" data-wow-delay=".2s">marcas de <span class="text-primary"> productos</span></h3>
          </div>
          <div class="row">
            <!-- Owl Carousel-->
            <div class="owl-carousel text-center owl-brand" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-xxl-items="5" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="true">
              ...
              <div class="item"><img src="images/brand-6-200x48.png" alt="" width="200" height="24"/>
              </div>
              <div class="item"><img src="images/brand-7-200x48.png" alt="" width="200" height="24"/>
              </div>
              <div class="item"><img src="images/brand-8-200x48.png" alt="" width="200" height="24"/>
              </div>
              <div class="item"><img src="images/brand-9-200x48.png" alt="" width="200" height="24"/>
              </div>
              <div class="item"><img src="images/brand-10-200x48.png" alt="" width="200" height="24"/>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="cell-xs-10 col-md-6 col-lg-4">
              <article class="box-minimal">
                ...
                <div class="box-minimal-text">
                  <p>Cuidamos mucho la estética, ten por seguro que recibirás un trabajo de calidad.</p>
                </div>
              </article>
            </div>
            <div class="cell-xs-10 col-md-6 col-lg-4">
              <article class="box-minimal">
                ...
                <h4 class="box-minimal-title">Garantía y Soporte</h4>
                <div class="box-minimal-text">
                  <p>Estamos disponibles para ayudarte en tus dudas y solucionar fallas que se presenten en cualquier momento, nuestros técnicos se encuentran disponibles para atenderte.</p>
                </div>
              </article>
            </div>
            <div class="cell-xs-10 col-md-6 col-lg-4">
              <article class="box-minimal">
                ...
                <div class="box-minimal-text">
                  <p>Tu inversión esta segura con nosotros, somos un equipo honesto que te entregará resultados óptimos.</p>
                </div>
              </article>
            </div>
          </div>
