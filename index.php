  ...
  <body>
    ...
    <?php include("header.php")?>
      ...
      <section class="section section-sm position-relative" id="about">
        ...
        <div class="decor-text decor-text-1">CONÓCENOS</div>
      </section>
      <!--Features-->
              ...
              <div class="row row-15">
                <div class="col-xl-6 wow fadeInUp" data-wow-delay=".2s">
                  <div class="box-default">
                    ...
                    <p class="box-default-description">Nos gusta ofrecer soluciones con tecnologías disruptivas.</p><span class="box-default-icon novi-icon icon-lg mercury-icon-lightbulb-gears"></span>
                  </div>
                </div>
                <div class="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                  <div class="box-default">
                    <div class="box-default-title">pensamiento estratégico</div>
                    <p class="box-default-description">Utilizamos los recursos y el tiempo de manera óptima.</p><span class="box-default-icon novi-icon icon-lg mercury-icon-target-2"></span>
                  </div>
                </div>
                <div class="col-xl-6 wow fadeInUp" data-wow-delay=".4s">
                  <div class="box-default">
                    <div class="box-default-title">experiencia</div>
                    <p class="box-default-description">Contamos con personal capacitado para atender a nuestros clientes.</p><span class="box-default-icon novi-icon icon-lg mercury-icon-user"></span>
                  </div>
                </div>
                <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                  <div class="box-default">
                    <div class="box-default-title">seguridad y confidencialidad</div>
                    <p class="box-default-description">Cuidamos la integridad de la información de nuestros clientes.</p><span class="box-default-icon novi-icon icon-lg mercury-icon-partners"></span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-10">
              ...
              <h3 class="wow fadeInLeft text-capitalize text-center" data-wow-delay=".3s">Lo Que Nuestros Clientes<span class="text-primary"> Opinan</span></h3>
